...
Из среды сборки сайт недоступен (egress-прокси), поэтому он выгружен через GitHub Actions (`scripts/fetch-source-site.mjs`): 256 страниц. Карта ниже — по реальному HTML. См. `CONTENT-INVENTORY.md`.
...
| `/vse-videoroliki/1…10` | Портфолио Видеопродакшн.РФ - Примеры видеороликов - Страница 01…10 | портфолио, 15 видео на страницу |
| `/otzyvy` | Отзывы | 39 видеоотзывов + 11 благодарственных писем |
| `/voprosy-i-otvety` | Вопрос/ответ | 23 вопроса |
| `/brif` | Бриф | форма |
...
| `/informacionnye_videoroliki` | Профессиональный информационный ролик для Вашего бизнеса |
| `/montazh_videorolikov` | Монтаж видеороликов любой сложности |
| `/videoobraschenie` | Видеообращение от CEO под ключ |
| `/imidzhevye_videoroliki` | Имиджевый ролик для бизнеса — создание репутации бренда |
| `/korporativnye_videoroliki` | Корпоративные ролики — эффективный инструмент для вашего бизнеса |
| `/videosyemka_nedvizhimosti` | Видеосъемка недвижимости под ключ — аэросъемка, 3D-туры, продающие ролики |
| `/predmetnaya_syemka` | Предметная съемка товаров под ключ |
| `/obuchayuschie_video` | Обучающие видео и видеокурсы |
| `/videosyemka_meropriyatiy` | Видеосъемка мероприятий — конференции, корпоративы, форумы |
| `/2d_animaciya` | 2D-анимация для бизнеса — объясняющие ролики, инфографика |
| `/syemka_video_dlya_socsetey` | Съемка видео для соцсетей: Reels, Shorts, TikTok |
| `/proizvodstvo` | Профессиональная съемка для промышленных компаний |
| `/otchetnye_videoroliki` | Создание отчетных роликов о проектах |
| `/forumy` | Видеосъемка деловых форумов |
| `/youtube` | Профессиональная видеосъемка для YouTube |
| `/videoinstrukcii` | Видеоинструкции для бизнеса |
| `/video_dlya_biznesa` | Видеоролики для B2B — создание кейсов, вебинаров и обучения |

Единственный пункт меню без своей страницы — «Запись вебинаров».
...
/                         Главная — hero c showreel, лента услуг, избранные работы (плёнка),
                          индекс услуг, процесс с плейхедом, цифры студии, команда («ПРОДАКШН» с восемью портретами), тарифы, отзывы
/work/                    Все проекты (142 видео с VK/YouTube/Kinescope), фильтр по 12 категориям (?type=…), подгрузка по 18
...
/services/                Все услуги (26), индекс на сетке
...
/about/                   О студии: позиционирование, цифры, команда (блок «ПРОДАКШН» с восемью портретами), принципы, история VIDEOKZN → Видеопродакшн.РФ
/reviews/                 39 видеоотзывов, 11 благодарственных писем
/faq/                     23 вопроса с исходного сайта (FAQPage JSON-LD)
...
- Футер: услуги (12 + ссылка на все 26), Студия (О студии, Процесс, Отзывы, FAQ, Контакты), Работы (по форматам), политика.

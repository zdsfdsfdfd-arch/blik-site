...
как есть (разметка, тексты, анимации не менялись). Изменения: синий акцент заменён на фиолетовый,
белые секции стали тёмно-фиолетовыми, с фото и логотипов снят чёрно-белый фильтр.
